...
export namespace GetBuildsResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        classes?: Array<Build$.Inbound> | undefined;
    };
    ...
    export const inboundSchema: z.ZodType<GetBuildsResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            classes: z.array(Build$.inboundSchema).optional(),
        })
        .transform((v) => ({
    ...
    export type Outbound = {
        ...
        StatusCode: number;
        RawResponse: never;
        classes?: Array<Build$.Outbound> | undefined;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetBuildsResponse> = z
        .object({
            ...
            classes: z.array(Build$.outboundSchema).optional(),
        })
        .transform((v) => ({
            ContentType: v.contentType,
            StatusCode: v.statusCode,
