...
export type GetActiveRoomsForProcessResponse = {
    /**
...
/** @internal */
export namespace GetActiveRoomsForProcessResponse$ {
    export type Inbound = {
        ContentType: string;
        StatusCode: number;
        RawResponse: Response;
    ...
    export const inboundSchema: z.ZodType<GetActiveRoomsForProcessResponse, z.ZodTypeDef, Inbound> =
        z
            .object({
