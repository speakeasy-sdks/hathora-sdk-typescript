...
export function resolveGlobalSecurity(security: Partial<models.Security> | null | undefined) {
    return resolveSecurity([
        { value: security?.hathoraDevToken, fieldName: "Authorization", type: "http:bearer" },
    ]);
}
